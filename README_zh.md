...
# **Open-POI-Deepresearch项目简介**

Open-POI-Deepresearch项目是一个全方位的出行规划助手，为您个人提供各项出行服务，如查找"离我附近5公里内的既有星巴克又有麦当劳又能剪头发还能看电影的地方"这类无法一次能查出来的地方，以及帮你制定靠谱的旅行计划，比如你要从"北京到杭州的6天5夜游，要求重体验感，慢节奏，考虑到天气因素定制化出行方案和景点贵哈，预算控制在3000元以内"。最终以报告行程呈现，可一键生成高德导航/打车链接。其由高德mcp提供出行工具服务，并且支持深度搜索和自我验证，对于不确定的消息会通过askhuman工具进行反问。并且最终版支持流式（正在开发中）。希望该项目能帮助你搭建属于自己的出行规划助手。
